  ...
  return (
    <main>
      <section className="uper-section">
        <h1 className="uper-section-heading">Contact Us</h1>
        ...
        <div className="contact-detail-div">
          <div className="contact-detail-one">
            <div className="contact-one-heading">
              <Image src={place2} alt="place" />
              <h1 className="text-[30px] font-bold text-[var(--secondary-color)]">Bahawalpur</h1>
            </div>
            <div className="flex gap-3 mt-[20px]">
              <FaPhone className="text-gray-600 mt-[17px]" />
              <p className="text-[var(--background-color)]">009-215-5596</p>
            </div>
            <div className="flex gap-3">
              <FaEnvelope className="text-gray-600 mt-[17px]" />
              <p className="text-[var(--background-color)]">mail@example.com</p>
            </div>
          </div>
          <div className="contact-div flex leading-[50px]">
            <div className="contact-two p-[40px]">
              <div className="flex gap-3">
                ...
                <h1 className="text-[30px] font-bold text-[var(--secondary-color)]">Lodhran</h1>
              </div>
              <div className="flex gap-3 mt-[20px]">
                <FaPhone className="text-gray-600 mt-[17px]" />
                <p className="text-[var(--background-color)]">009-215-5596</p>
